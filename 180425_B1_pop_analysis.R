...
#B1 population SNPs
B1_snps <- read.csv("B1_Breseq_Output.csv",header=TRUE)
...
B1_filter4 <- (subset(B1_filter3, B1_filter3$Sums < 400))
nrow(B1_filter4) #1198
B1_filter4_out <- (subset(B1_filter3, B1_filter3$Sums >= 400))
...
write.csv(B1_split5,file="B1_allfilters.csv")
...
View(B1_split5)
B1_Muller <- B1_split5[,c(1:7)]
B1_Muller$Population <- "B1"
B1_Muller$Population2 <- 1 #make sure this is a number
B1_Muller$Chromosome <- 1 #make sure this is a number
B1_Muller$Position <- B1_split5$Position
B1_Muller$Class <- "SNP"
B1_Muller$Mutation <- B1_split5$Mutation
B1_Muller$Gene <- ""
B1_Muller$AminoAcid <- ""
B1_Muller$Class2 <- ""
B1_Muller$Amino <- ""
...
B1_Muller_try <- B1_Muller
B1_Muller_try$`90` <- as.numeric(as.character(B1_Muller_try$`90`))
B1_Muller_try$`75` <- as.numeric(as.character(B1_Muller_try$`75`))
B1_Muller_try$`66` <- as.numeric(as.character(B1_Muller_try$`66`))
B1_Muller_try$`44` <- as.numeric(as.character(B1_Muller_try$`44`))
B1_Muller_try$`25` <- as.numeric(as.character(B1_Muller_try$`25`))
B1_Muller_try$`17` <- as.numeric(as.character(B1_Muller_try$`17`))
B1_Muller_try$`0` <- as.numeric(as.character(B1_Muller_try$`0`))
...
B1_Muller_try$`90` <- (B1_Muller_try$`90`/100)
B1_Muller_try$`75` <- (B1_Muller_try$`75`/100)
B1_Muller_try$`66` <- (B1_Muller_try$`66`/100)
B1_Muller_try$`44` <- (B1_Muller_try$`44`/100)
B1_Muller_try$`25` <- (B1_Muller_try$`25`/100)
B1_Muller_try$`17` <- (B1_Muller_try$`17`/100)
B1_Muller_try$`0` <- (B1_Muller_try$`0`/100)
...
write.xlsx(B1_Muller_try, file="B1_Muller.xlsx", row.names = FALSE)
